...
%~dp0\..\bin\remote.exe 127.0.0.1 7000 conte -v -a -b gray -d 600 -p 4 --border green,8 -f +,0,0,1,black,2,0 -c red -c green --show-cue-rects --trials %~dp0\conte-trials.csv --generate-dots 50
