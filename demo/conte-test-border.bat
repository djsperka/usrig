...
%~dp0\..\bin\remote.exe 127.0.0.1 7000 conte -v -b gray -d 600 -p 4 --fixpt-cutoff --border green,8 -f +,0,0,1,black,2,0 -c red -c green --trials %~dp0\conte-trials.csv --generate-dots 50
REM don't use --show-cue-rects 
REM --fixpt-cutoff 