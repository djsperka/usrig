...
%~dp0\..\bin\remote.exe 127.0.0.1 7000 fixstim -f 0,0,1.0,red -b gray -d 813 -a -v -d 500 -f 0,0,.5,green -s -6,-5,5,5,100,.5,.1,45,b,s,e -O 0,45,90 --draw-group 2 -s -6,5,5,5,100,.5,.2,180,b,s,e
